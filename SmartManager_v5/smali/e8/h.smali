...
.method static constructor <clinit>()V
    ...
    sput-object v1, Le8/h;->d:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Paint$FontMetrics;

    invoke-direct {v1}, Landroid/graphics/Paint$FontMetrics;-><init>()V

    sput-object v1, Le8/h;->e:Landroid/graphics/Paint$FontMetrics;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    sput-object v1, Le8/h;->f:Landroid/graphics/Rect;

    new-instance v1, Ly7/b;

    invoke-direct {v1, v0}, Ly7/b;-><init>(I)V

    sput-object v1, Le8/h;->g:Ly7/b;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    sput-object v0, Le8/h;->h:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    sput-object v0, Le8/h;->i:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Paint$FontMetrics;

    invoke-direct {v0}, Landroid/graphics/Paint$FontMetrics;-><init>()V

    sput-object v0, Le8/h;->j:Landroid/graphics/Paint$FontMetrics;
...
.method public static a(Landroid/graphics/Paint;Ljava/lang/String;)I
    ...
    sget-object v0, Le8/h;->d:Landroid/graphics/Rect;
...
.method public static b(Landroid/graphics/Paint;Ljava/lang/String;)Le8/b;
    .locals 4

    sget-object v0, Le8/b;->d:Le8/f;
    ...
    iput v1, v0, Le8/b;->b:F

    iput v1, v0, Le8/b;->c:F

    sget-object v1, Le8/h;->f:Landroid/graphics/Rect;
...
.method public static c(F)F
    ...
    sget-object v0, Le8/h;->a:Landroid/util/DisplayMetrics;
...
.method public static d(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;IIII)V
    ...
    sget-object p2, Le8/h;->h:Landroid/graphics/Rect;
    ...
    iget p3, v0, Le8/d;->b:F

    iget p4, v0, Le8/d;->c:F
