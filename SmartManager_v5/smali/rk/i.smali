...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v3}, Lrk/c;->c(Lrk/f;)Lrk/c;
    ...
    invoke-virtual {v3, v6}, Lrk/c;->c(Lrk/f;)Lrk/c;
    ...
    sput-object v3, Lrk/i;->e:Lrk/c;

    invoke-static {v5}, Lrk/f;->e(Ljava/lang/String;)Lrk/f;

    move-result-object v5

    invoke-virtual {v0, v5}, Lrk/c;->c(Lrk/f;)Lrk/c;
    ...
    invoke-virtual {v5, v6}, Lrk/c;->c(Lrk/f;)Lrk/c;
    ...
    invoke-virtual {v0, v6}, Lrk/c;->c(Lrk/f;)Lrk/c;

    move-result-object v6

    sput-object v6, Lrk/i;->f:Lrk/c;

    const-string v7, "enums"

    invoke-static {v7}, Lrk/f;->e(Ljava/lang/String;)Lrk/f;

    move-result-object v7

    invoke-virtual {v0, v7}, Lrk/c;->c(Lrk/f;)Lrk/c;

    move-result-object v7

    sput-object v7, Lrk/i;->g:Lrk/c;

    filled-new-array/range {v0 .. v6}, [Lrk/c;
    ...
    invoke-static {v0}, Lrk/j;->a(Ljava/lang/String;)Lrk/b;
    ...
    invoke-static {v3}, Lrk/j;->f(Lrk/b;)Lrk/b;

    move-result-object v0

    sput-object v0, Lrk/i;->i:Lrk/b;

    invoke-static {v4}, Lrk/j;->f(Lrk/b;)Lrk/b;

    move-result-object v0

    sput-object v0, Lrk/i;->j:Lrk/b;

    invoke-static {v5}, Lrk/j;->f(Lrk/b;)Lrk/b;

    move-result-object v0

    sput-object v0, Lrk/i;->k:Lrk/b;

    invoke-static {v6}, Lrk/j;->f(Lrk/b;)Lrk/b;
    ...
    invoke-static {v0}, Lrk/j;->e(Ljava/lang/String;)Lrk/b;
    ...
    sput-object v0, Lrk/i;->o:Ljava/util/Set;
    ...
    :cond_1
    invoke-static {v1}, Lrk/j;->c(Ljava/util/LinkedHashMap;)V

    sget-object v0, Lrk/i;->i:Lrk/b;

    sget-object v1, Lrk/i;->j:Lrk/b;

    sget-object v3, Lrk/i;->k:Lrk/b;

    sget-object v6, Lrk/i;->l:Lrk/b;

    filled-new-array {v0, v1, v3, v6}, [Lrk/b;
    ...
    sput-object v0, Lrk/i;->p:Ljava/util/Set;
    ...
    sget-object v0, Lrk/i;->o:Ljava/util/Set;

    sget-object v1, Lrk/i;->p:Ljava/util/Set;
    ...
    invoke-static {v1}, Lrk/c;->j(Lrk/f;)Lrk/c;
    ...
    invoke-static {v1}, Lrk/j;->b(Ljava/lang/String;)Lrk/b;
    ...
    invoke-virtual {v0, v4}, Lrk/b;->d(Lrk/f;)Lrk/b;
    ...
    invoke-virtual {v1, v0}, Lrk/b;->d(Lrk/f;)Lrk/b;
