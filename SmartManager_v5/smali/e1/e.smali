...
.method public constructor <init>(Ljava/lang/CharSequence;Landroid/text/TextPaint;I)V
    ...
    iput-object p2, p0, Le1/e;->b:Landroid/text/TextPaint;

    iput p3, p0, Le1/e;->c:I

    const/high16 p1, 0x7fc00000    # Float.NaN

    iput p1, p0, Le1/e;->d:F

    iput p1, p0, Le1/e;->e:F
...
.method public final a()Landroid/text/BoringLayout$Metrics;
    ...
    invoke-static {v0}, Le1/j;->a(I)Landroid/text/TextDirectionHeuristic;

    move-result-object v0

    sget v1, Landroid/os/Build$VERSION;->SDK_INT:I

    iget-object v2, p0, Le1/e;->a:Ljava/lang/CharSequence;

    iget-object v3, p0, Le1/e;->b:Landroid/text/TextPaint;

    const/16 v4, 0x21

    if-lt v1, v4, :cond_0

    invoke-static {v2, v3, v0}, Landroidx/activity/t;->f(Ljava/lang/CharSequence;Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;)Landroid/text/BoringLayout$Metrics;
    ...
    :goto_0
    iput-object v0, p0, Le1/e;->f:Landroid/text/BoringLayout$Metrics;

    const/4 v0, 0x1

    iput-boolean v0, p0, Le1/e;->g:Z

    :cond_2
    iget-object p0, p0, Le1/e;->f:Landroid/text/BoringLayout$Metrics;
...
.method public final b()F
    ...
    iget p0, p0, Le1/e;->d:F

    goto/16 :goto_3

    :cond_0
    invoke-virtual {p0}, Le1/e;->a()Landroid/text/BoringLayout$Metrics;
    ...
    :goto_0
    iget-object v1, p0, Le1/e;->b:Landroid/text/TextPaint;
