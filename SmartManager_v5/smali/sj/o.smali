...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v0}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    const-string v2, "java/lang/annotation/Annotation.annotationType()Ljava/lang/Class;"

    invoke-static {v0, v2}, Lsi/g0;->E(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, Lsj/o;->a:Ljava/util/LinkedHashSet;

    sget-object v0, Lzk/c;->t:Lzk/c;

    sget-object v2, Lzk/c;->u:Lzk/c;

    filled-new-array {v0, v2}, [Lzk/c;
    ...
    invoke-virtual {v5}, Lrk/f;->b()Ljava/lang/String;
    ...
    iget-object v6, v3, Lzk/c;->b:Ljava/lang/String;
    ...
    invoke-static {v5, v3}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v3}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v3

    invoke-static {v2, v3}, Lsi/g0;->D(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v6, v3}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v8}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v8

    invoke-static {v2, v8}, Lsi/g0;->D(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v3}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, Lsj/o;->b:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v2}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v3}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1, v3}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v8}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v8}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, Lsj/o;->c:Ljava/util/LinkedHashSet;

    filled-new-array {v11}, [Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v0}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    invoke-static {v1, v0}, Lsi/g0;->D(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v1}, Lkk/e;->g(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, Lsj/o;->d:Ljava/util/LinkedHashSet;

    sget-object v10, Lzk/c;->t:Lzk/c;

    sget-object v14, Lzk/c;->v:Lzk/c;

    sget-object v12, Lzk/c;->A:Lzk/c;

    sget-object v13, Lzk/c;->y:Lzk/c;

    sget-object v15, Lzk/c;->x:Lzk/c;

    sget-object v16, Lzk/c;->z:Lzk/c;

    sget-object v17, Lzk/c;->w:Lzk/c;

    move-object v11, v14

    filled-new-array/range {v10 .. v17}, [Lzk/c;
    ...
    invoke-virtual {v2}, Lzk/c;->e()Lrk/c;
    ...
    invoke-static {v3}, Lkk/e;->b([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v2

    invoke-static {v1, v2}, Lsi/u;->r0(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    invoke-static {v0}, Lkk/e;->b([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v7, v0}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1}, Lkk/e;->b([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v6, v1}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, Lsj/o;->e:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v0}, Lkk/e;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, Lsj/o;->f:Ljava/util/LinkedHashSet;
