...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnj/w1;->a:Lrk/c;

    return-void
.end method

.method public static final a(Lkj/c;)Lnj/r;
    .locals 1

    instance-of v0, p0, Lnj/r;
    ...
    invoke-static {p0}, Lnj/w1;->b(Ljava/lang/Object;)Lnj/f0;
...
.method public static final b(Ljava/lang/Object;)Lnj/f0;
    .locals 2

    instance-of v0, p0, Lnj/f0;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->compute()Lkj/c;
...
.method public static final c(Ljava/lang/Object;)Lnj/j1;
    .locals 2

    instance-of v0, p0, Lnj/j1;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/w;->compute()Lkj/c;
...
.method public static final d(Luj/a;)Ljava/util/ArrayList;
    .locals 6
    ...
    invoke-interface {v1}, Luj/b;->getSource()Ltj/m0;

    move-result-object v3

    instance-of v4, v3, Lyj/a;

    if-eqz v4, :cond_1

    check-cast v3, Lyj/a;

    iget-object v2, v3, Lyj/a;->a:Ljava/lang/annotation/Annotation;

    goto :goto_2

    :cond_1
    instance-of v4, v3, Lyj/f;

    if-eqz v4, :cond_3

    check-cast v3, Lyj/f;

    iget-object v1, v3, Lyj/f;->a:Lzj/r;

    instance-of v3, v1, Lzj/d;
    ...
    iget-object v2, v1, Lzj/d;->a:Ljava/lang/annotation/Annotation;

    goto :goto_2

    :cond_3
    invoke-static {v1}, Lnj/w1;->i(Luj/b;)Ljava/lang/annotation/Annotation;
    ...
    const-class v5, Lkotlin/jvm/internal/d0;
...
.method public static final f(Ljava/lang/Class;Lsk/l;Lok/f;Lo7/d;Lok/a;Lej/n;)Ltj/b;
    .locals 13
    ...
    iget-object v2, v2, Lmk/y;->x:Ljava/util/List;
    ...
    iget-object v2, v2, Lmk/g0;->x:Ljava/util/List;

    goto :goto_0

    :goto_1
    new-instance v12, Lel/k;

    iget-object v3, v1, Lyj/e;->a:Lel/i;

    iget-object v5, v3, Lel/i;->b:Ltj/x;

    sget-object v7, Lok/g;->a:Lok/g;
    ...
    invoke-direct/range {v2 .. v11}, Lel/k;-><init>(Lel/i;Lok/f;Ltj/j;Lo7/d;Lok/g;Lok/a;Lkk/f;Lel/a0;Ljava/util/List;)V

    new-instance v1, Lel/r;

    invoke-direct {v1, v12}, Lel/r;-><init>(Lel/k;)V

    move-object/from16 v2, p5

    invoke-interface {v2, v1, p1}, Lej/n;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final g(Ltj/c;)Lwj/w;
    .locals 1
...
.method public static final h(Ljava/lang/ClassLoader;Lrk/b;I)Ljava/lang/Class;
    .locals 4
    ...
    invoke-static {p1, v2, v0}, Ltl/n;->S(Ljava/lang/String;CC)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lp1/c;->d0(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Class;
...
.method public static final i(Luj/b;)Ljava/lang/annotation/Annotation;
    .locals 7
    ...
    invoke-static {v3, v5}, Lnj/w1;->k(Lwk/g;Ljava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    invoke-direct {v5, v4, v3}, Lri/f;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_5
    invoke-static {v2}, Lsi/d0;->Z(Ljava/util/List;)Ljava/util/Map;
    ...
    :cond_6
    invoke-static {v0, p0, v3}, Lli/c;->n(Ljava/lang/Class;Ljava/util/Map;Ljava/util/List;)Ljava/lang/Object;
...
.method public static final j(Ltj/e;)Ljava/lang/Class;
    .locals 2
    ...
    instance-of v1, v0, Lkk/m;

    if-eqz v1, :cond_0

    check-cast v0, Lkk/m;

    iget-object p0, v0, Lkk/m;->a:Lyj/b;
    ...
    :cond_0
    instance-of v1, v0, Lyj/f;

    if-eqz v1, :cond_1

    check-cast v0, Lyj/f;

    iget-object p0, v0, Lyj/f;->a:Lzj/r;
    ...
    invoke-static {p0}, Lzj/c;->d(Ljava/lang/Class;)Ljava/lang/ClassLoader;

    move-result-object p0

    const/4 v1, 0x0

    invoke-static {p0, v0, v1}, Lnj/w1;->h(Ljava/lang/ClassLoader;Lrk/b;I)Ljava/lang/Class;
...
.method public static final k(Lwk/g;Ljava/lang/ClassLoader;)Ljava/lang/Object;
    .locals 7

    const/4 v0, 0x1

    instance-of v1, p0, Lwk/a;
    ...
    invoke-static {p0}, Lnj/w1;->i(Luj/b;)Ljava/lang/annotation/Annotation;
    ...
    iget-object v1, v1, Lwk/w;->c:Lil/w;
    ...
    :cond_2
    iget-object v4, p0, Lwk/g;->a:Ljava/lang/Object;
    ...
    invoke-static {v6, p1}, Lnj/w1;->k(Lwk/g;Ljava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    :cond_4
    invoke-static {v4}, Lqj/h;->r(Ltj/g;)Lqj/j;
    ...
    :pswitch_9
    invoke-static {v1}, Lqj/h;->y(Lil/w;)Z
    ...
    sget-object v6, Lqj/m;->f:Lrk/e;

    invoke-static {v1, v6}, Lqj/h;->D(Lil/w;Lrk/e;)Z
    ...
    :cond_7
    sget-object v1, Lqj/m;->P:Lrk/e;

    invoke-static {v4, v1}, Lqj/h;->b(Ltj/e;Lrk/e;)Z
    ...
    invoke-static {p1, v1, v2}, Lnj/w1;->h(Ljava/lang/ClassLoader;Lrk/b;I)Ljava/lang/Class;
    ...
    invoke-static {p1, v0, v2}, Lnj/w1;->h(Ljava/lang/ClassLoader;Lrk/b;I)Ljava/lang/Class;
    ...
    iget-object v0, p0, Lwk/f;->a:Lrk/b;

    iget p0, p0, Lwk/f;->b:I

    invoke-static {p1, v0, p0}, Lnj/w1;->h(Ljava/lang/ClassLoader;Lrk/b;I)Ljava/lang/Class;
    ...
    :cond_15
    invoke-virtual {p0}, Lwk/g;->b()Ljava/lang/Object;
