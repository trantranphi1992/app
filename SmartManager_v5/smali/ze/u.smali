...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lze/u;->f:Landroid/content/Context;

    new-instance v0, Lxc/b;

    invoke-direct {v0, p1}, Lxc/b;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lze/u;->e:Lxc/b;

    const-string p1, "sem_power_mode_refresh_rate_cover"
    ...
    const-string v2, "PowerModeRefreshRateCover"

    const-string v4, "need to init : sem_power_mode_refresh_rate_cover"
...
.method public final e()Ljava/lang/String;
    ...
    const-string p0, "psm_refresh_rate_cover_tag"
...
.method public final g()I
    ...
    iget-object p0, p0, Lze/u;->e:Lxc/b;
...
.method public final i()I
    ...
    const-string v0, "sem_power_mode_refresh_rate_cover"
...
.method public final k()Z
    ...
    const-string v0, "psm_refresh_rate_cover_tag"
...
.method public final r(I)V
    ...
    iget-object v0, p0, Lze/u;->f:Landroid/content/Context;

    invoke-virtual {v0, p1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0}, Lze/u;->k()Z
...
.method public final s(Z)V
    ...
    const-string v1, "PowerModeRefreshRateCover"
...
.method public final u(I)V
    ...
    :cond_0
    iget-object v0, p0, Lze/u;->e:Lxc/b;

    const/4 v1, 0x0

    const-string v2, "sem_power_mode_refresh_rate_cover"

    invoke-virtual {v0, p1, v1, p1, v2}, Lxc/b;->g(IIILjava/lang/String;)V

    iget-object p0, p0, Lze/u;->f:Landroid/content/Context;

    invoke-virtual {p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object p0

    const-string v0, "pms_override_refresh_rate_mode_cover"
...
.method public final w()V
    ...
    iget-object v1, p0, Lze/u;->e:Lxc/b;
    ...
    iget-object v4, p0, Lze/u;->f:Landroid/content/Context;
    ...
    const-string v7, "turn off, cover refresh rate to be restored : "
    ...
    const-string v7, "PowerModeRefreshRateCover"
    ...
    invoke-virtual {p0, v8, v0, v2}, Lze/u;->y(IIZ)Ljava/lang/String;
    ...
    const-string v10, "refresh_rate_mode_cover"
    ...
    :goto_2
    const-string p0, "pms_settings_refresh_rate_cover_enabled"
...
.method public final x()V
    ...
    const-string v2, "turn on, current cover refresh rate : "
    ...
    iget-object v3, p0, Lze/u;->f:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0, v5, v4}, Lze/u;->y(IIZ)Ljava/lang/String;
    ...
    const-string v9, "refresh_rate_mode_cover"

    invoke-virtual {v1, v9, v6, v7, v8}, Lqd/a;->c(Ljava/lang/String;Ljava/lang/String;J)V

    const-string v1, "sem_power_mode_refresh_rate_cover"
    ...
    const-string v3, "pms_override_refresh_rate_mode_cover"
    ...
    const-string v0, "pms_settings_refresh_rate_cover_enabled"
