...
.method public constructor <init>(Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;Landroid/content/res/Resources;)V
    ...
    iget-object p2, p1, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lk/i;

    iput-object p2, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lk/i;

    iget-object p1, p1, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Lk/v;

    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Lk/v;
    ...
    invoke-direct {p1, p2}, Lk/i;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lk/i;

    new-instance p1, Lk/v;

    const/4 p2, 0x0

    invoke-direct {p1, p2}, Lk/v;-><init>(I)V
...
.method public addStateSet([ILandroid/graphics/drawable/Drawable;I)I
    ...
    iget-object p0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Lk/v;
...
.method public addTransition(IILandroid/graphics/drawable/Drawable;Z)I
    ...
    :goto_0
    iget-object v4, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lk/i;
    ...
    invoke-virtual {v4, v0, v1, v7}, Lk/i;->a(JLjava/lang/Long;)V
    ...
    iget-object p0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lk/i;
    ...
    invoke-virtual {p0, p1, p2, p4}, Lk/i;->a(JLjava/lang/Long;)V
...
.method public getKeyframeIdAt(I)I
    ...
    invoke-static {v2, p1, v1}, Ll/a;->a(II[I)I
...
.method public indexOfTransition(II)I
    ...
    invoke-virtual {p0, p1, p2}, Lk/i;->e(J)Ljava/lang/Object;
...
.method public mutate()V
    ...
    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lk/i;

    invoke-virtual {v0}, Lk/i;->c()Lk/i;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Lk/i;

    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Lk/v;

    invoke-virtual {v0}, Lk/v;->b()Lk/v;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Lk/v;
