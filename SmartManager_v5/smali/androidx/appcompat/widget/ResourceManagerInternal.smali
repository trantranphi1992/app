...
.field private mKnownDrawableIdTags:Lk/v;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lk/v;"
        }
...
.method private addDelegate(Ljava/lang/String;Landroidx/appcompat/widget/ResourceManagerInternal$InflateDelegate;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mDelegates:Lk/u;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mDelegates:Lk/u;

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mDelegates:Lk/u;
...
.method private declared-synchronized addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Lk/i;->h(JLjava/lang/Object;)V
    :try_end_0
...
.method private addTintListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, Lk/v;->a(ILjava/lang/Object;)V
...
.method private declared-synchronized getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Lk/i;->d(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    iget-object p1, v0, Lk/i;->b:[J

    iget v2, v0, Lk/i;->s:I

    invoke-static {p1, v2, p2, p3}, Ll/a;->b([JIJ)I

    move-result p1

    if-ltz p1, :cond_2

    iget-object p2, v0, Lk/i;->r:[Ljava/lang/Object;
...
.method private getTintListFromCache(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p2}, Lk/v;->c(I)Ljava/lang/Object;
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Lk/u;->isEmpty()Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mKnownDrawableIdTags:Lk/v;

    const-string v2, "appcompat_skip_skip"

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2}, Lk/v;->c(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mDelegates:Lk/u;

    invoke-virtual {v3, v0}, Lk/u;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mKnownDrawableIdTags:Lk/v;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mKnownDrawableIdTags:Lk/v;

    invoke-virtual {v8, p2, v3}, Lk/v;->a(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mDelegates:Lk/u;

    invoke-virtual {v8, v3}, Lk/u;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mKnownDrawableIdTags:Lk/v;

    invoke-virtual {p0, p2, v2}, Lk/v;->a(ILjava/lang/Object;)V
