...
.field private static final sActivityDelegates:Lk/f;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroidx/appcompat/app/AppCompatDelegate;->sActivityDelegates:Lk/f;
...
.method public static addActiveDelegate(Landroidx/appcompat/app/AppCompatDelegate;)V
    ...
    sget-object v1, Landroidx/appcompat/app/AppCompatDelegate;->sActivityDelegates:Lk/f;

    new-instance v2, Ljava/lang/ref/WeakReference;

    invoke-direct {v2, p0}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v1, v2}, Lk/f;->add(Ljava/lang/Object;)Z
...
.method private static applyDayNightToActiveDelegates()V
    ...
    invoke-direct {v2, v1}, Lk/a;-><init>(Lk/f;)V

    :cond_0
    :goto_0
    invoke-virtual {v2}, Lk/a;->hasNext()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {v2}, Lk/a;->next()Ljava/lang/Object;
...
.method private static applyLocalesToActiveDelegates()V
    ...
    sget-object v0, Landroidx/appcompat/app/AppCompatDelegate;->sActivityDelegates:Lk/f;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v1, Lk/a;

    invoke-direct {v1, v0}, Lk/a;-><init>(Lk/f;)V
    ...
    invoke-virtual {v1}, Lk/a;->next()Ljava/lang/Object;
...
.method private static removeDelegateFromActives(Landroidx/appcompat/app/AppCompatDelegate;)V
    ...
    :cond_1
    invoke-virtual {v2}, Lk/a;->remove()V
