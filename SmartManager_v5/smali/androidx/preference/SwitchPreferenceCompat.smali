...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Landroidx/preference/f0;->switchPreferenceCompatStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Landroidx/preference/SwitchPreferenceCompat;->r0:Landroidx/preference/a;

    const/4 v0, 0x0

    iput v0, p0, Landroidx/preference/SwitchPreferenceCompat;->v0:I
    ...
    iput-object v1, p0, Landroidx/preference/SwitchPreferenceCompat;->w0:Landroidx/preference/m;

    iput v0, p0, Landroidx/preference/SwitchPreferenceCompat;->u0:I

    sget-object v1, Landroidx/preference/m0;->SwitchPreferenceCompat:[I

    invoke-virtual {p1, p2, v1, p3, p4}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Landroidx/preference/m0;->SwitchPreferenceCompat_summaryOn:I

    sget p3, Landroidx/preference/m0;->SwitchPreferenceCompat_android_summaryOn:I
    ...
    :cond_0
    sget p2, Landroidx/preference/m0;->SwitchPreferenceCompat_summaryOff:I

    sget p3, Landroidx/preference/m0;->SwitchPreferenceCompat_android_summaryOff:I
    ...
    :cond_1
    sget p2, Landroidx/preference/m0;->SwitchPreferenceCompat_switchTextOn:I

    sget p3, Landroidx/preference/m0;->SwitchPreferenceCompat_android_switchTextOn:I
    ...
    sget p2, Landroidx/preference/m0;->SwitchPreferenceCompat_switchTextOff:I

    sget p3, Landroidx/preference/m0;->SwitchPreferenceCompat_android_switchTextOff:I
    ...
    sget p2, Landroidx/preference/m0;->SwitchPreferenceCompat_disableDependentsState:I

    sget p3, Landroidx/preference/m0;->SwitchPreferenceCompat_android_disableDependentsState:I
...
.method public final B(Landroid/view/View;)V
    ...
    :cond_0
    iget v0, p0, Landroidx/preference/SwitchPreferenceCompat;->u0:I
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/SwitchPreferenceCompat;->T(Landroid/view/View;)V
...
.method public final T(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroidx/preference/SwitchPreferenceCompat;->r0:Landroidx/preference/a;
    ...
    iget-object v0, p0, Landroidx/preference/SwitchPreferenceCompat;->w0:Landroidx/preference/m;
