...
# static fields
.field public static final v:Lmk/g;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmk/g;->w:Lmk/a;

    new-instance v0, Lmk/g;

    invoke-direct {v0}, Lmk/g;-><init>()V

    sput-object v0, Lmk/g;->v:Lmk/g;

    const/4 v1, 0x0

    iput v1, v0, Lmk/g;->r:I

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lmk/g;->s:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lmk/g;->t:B

    iput v0, p0, Lmk/g;->u:I

    sget-object v0, Lsk/e;->a:Lsk/u;

    iput-object v0, p0, Lmk/g;->a:Lsk/e;
...
.method public constructor <init>(Lmk/f;)V
    ...
    iput-object p1, p0, Lmk/g;->a:Lsk/e;
...
.method public constructor <init>(Lsk/f;Lsk/h;)V
    ...
    iput v0, p0, Lmk/g;->r:I

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lmk/g;->s:Ljava/util/List;
    ...
    invoke-virtual {p1, v6, v3}, Lsk/f;->q(ILcom/google/android/material/textfield/k;)Z
    ...
    iput-object v6, p0, Lmk/g;->s:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v6, p0, Lmk/g;->s:Ljava/util/List;

    sget-object v7, Lmk/e;->w:Lmk/a;
    ...
    :cond_4
    iget v6, p0, Lmk/g;->b:I

    or-int/2addr v6, v2

    iput v6, p0, Lmk/g;->b:I

    invoke-virtual {p1}, Lsk/f;->k()I

    move-result v6

    iput v6, p0, Lmk/g;->r:I
    :try_end_0
    ...
    iget-object p2, p0, Lmk/g;->s:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lmk/g;->s:Ljava/util/List;
    ...
    iput-object p2, p0, Lmk/g;->a:Lsk/e;
    ...
    iget-object p1, p0, Lmk/g;->s:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lmk/g;->s:Ljava/util/List;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, Lmk/g;->s:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lmk/e;->b()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lmk/g;->t:B
...
.method public final c()I
    ...
    :goto_0
    iget-object v1, p0, Lmk/g;->s:Ljava/util/List;
    ...
    :cond_2
    iget-object v1, p0, Lmk/g;->a:Lsk/e;
...
.method public final f(Lcom/google/android/material/textfield/k;)V
    ...
    :cond_1
    iget-object p0, p0, Lmk/g;->a:Lsk/e;
