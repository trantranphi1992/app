...
# static fields
.field public static final x:Lmk/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmk/l;->y:Lmk/a;

    new-instance v0, Lmk/l;

    invoke-direct {v0}, Lmk/l;-><init>()V

    sput-object v0, Lmk/l;->x:Lmk/l;

    const/4 v1, 0x6

    iput v1, v0, Lmk/l;->s:I
    ...
    iput-object v1, v0, Lmk/l;->u:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lmk/l;->v:B

    iput v0, p0, Lmk/l;->w:I

    sget-object v0, Lsk/e;->a:Lsk/u;

    iput-object v0, p0, Lmk/l;->b:Lsk/e;
...
.method public constructor <init>(Lmk/k;)V
    ...
    iput-object p1, p0, Lmk/l;->b:Lsk/e;
...
.method public constructor <init>(Lsk/f;Lsk/h;)V
    ...
    iput v0, p0, Lmk/l;->s:I

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lmk/l;->t:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lmk/l;->u:Ljava/util/List;
    ...
    invoke-virtual {p1, v7}, Lsk/f;->d(I)I
    ...
    iput-object v8, p0, Lmk/l;->u:Ljava/util/List;
    ...
    iget-object v8, p0, Lmk/l;->u:Ljava/util/List;
    ...
    :cond_4
    invoke-virtual {p1, v7}, Lsk/f;->c(I)V
    ...
    iput-object v7, p0, Lmk/l;->u:Ljava/util/List;

    or-int/lit8 v4, v4, 0x4

    :cond_6
    iget-object v7, p0, Lmk/l;->u:Ljava/util/List;
    ...
    iput-object v7, p0, Lmk/l;->t:Ljava/util/List;

    or-int/lit8 v4, v4, 0x2

    :cond_8
    iget-object v7, p0, Lmk/l;->t:Ljava/util/List;

    sget-object v8, Lmk/y0;->B:Lmk/a;
    ...
    :cond_9
    iget v7, p0, Lmk/l;->r:I

    or-int/2addr v7, v1

    iput v7, p0, Lmk/l;->r:I

    invoke-virtual {p1}, Lsk/f;->k()I

    move-result v7

    iput v7, p0, Lmk/l;->s:I
    :try_end_0
    ...
    iget-object p2, p0, Lmk/l;->t:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lmk/l;->t:Ljava/util/List;
    ...
    iget-object p2, p0, Lmk/l;->u:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lmk/l;->u:Ljava/util/List;
    ...
    iput-object p2, p0, Lmk/l;->b:Lsk/e;
    ...
    iget-object p1, p0, Lmk/l;->t:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lmk/l;->t:Ljava/util/List;
    ...
    iget-object p1, p0, Lmk/l;->u:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lmk/l;->u:Ljava/util/List;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, Lmk/l;->t:Ljava/util/List;
...
.method public final c()I
    ...
    :goto_2
    iget-object v3, p0, Lmk/l;->u:Ljava/util/List;
    ...
    iget-object v1, p0, Lmk/l;->u:Ljava/util/List;
    ...
    iget-object v1, p0, Lmk/l;->b:Lsk/e;
...
.method public final f(Lcom/google/android/material/textfield/k;)V
    ...
    :cond_1
    :goto_1
    iget-object v2, p0, Lmk/l;->u:Ljava/util/List;
    ...
    iget-object p0, p0, Lmk/l;->b:Lsk/e;
