...
# static fields
.field public static final t:Lmk/k0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmk/k0;->u:Lmk/a;

    new-instance v0, Lmk/k0;

    invoke-direct {v0}, Lmk/k0;-><init>()V

    sput-object v0, Lmk/k0;->t:Lmk/k0;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lmk/k0;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lmk/k0;->r:B

    iput v0, p0, Lmk/k0;->s:I

    sget-object v0, Lsk/e;->a:Lsk/u;

    iput-object v0, p0, Lmk/k0;->a:Lsk/e;
...
.method public constructor <init>(Lmk/m;)V
    ...
    iput-object p1, p0, Lmk/k0;->a:Lsk/e;
...
.method public constructor <init>(Lsk/f;Lsk/h;)V
    ...
    iput-object v0, p0, Lmk/k0;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lmk/k0;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, Lmk/k0;->b:Ljava/util/List;

    sget-object v6, Lmk/j0;->x:Lmk/a;
    ...
    iget-object p2, p0, Lmk/k0;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lmk/k0;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lmk/k0;->a:Lsk/e;
    ...
    iget-object p1, p0, Lmk/k0;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lmk/k0;->b:Ljava/util/List;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, Lmk/k0;->b:Ljava/util/List;
    ...
    check-cast v3, Lmk/j0;

    invoke-virtual {v3}, Lmk/j0;->b()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lmk/k0;->r:B
...
.method public final c()I
    ...
    :goto_0
    iget-object v2, p0, Lmk/k0;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lmk/k0;->a:Lsk/e;
...
.method public final f(Lcom/google/android/material/textfield/k;)V
    ...
    invoke-virtual {p0}, Lmk/k0;->c()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lmk/k0;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lmk/k0;->a:Lsk/e;
